...
<body>
    ...
    <div class="login-form">
        <form action="<?php echo e(route('registerApi')); ?>" method="post">
            <?php echo csrf_field(); ?>
        ...
        <p class="text-center small">Don't have an account? <a href="<?php echo e(route('login')); ?>">Sign up here!</a></p>
    </div>
</body>

</html><?php /**PATH F:\PHP TASK DAILY\FRONTEND\laravel_call_api\resources\views/register.blade.php ENDPATH**/ ?>